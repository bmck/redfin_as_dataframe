require_relative 'lib/redfin_as_dataframe/version'

Gem::Specification.new do |spec|
  spec.name          = "redfin_as_dataframe"
  spec.version       = RedfinAsDataframe::VERSION
  spec.authors       = ["Bill McKinnon"]
  spec.email         = ["bill.mckinnon@bmck.org"]

  spec.summary       = 'Home purchase metrics published by Redfin' 
